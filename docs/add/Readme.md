...
| # | Chapter | Summary |
|---|---|---|
| — | [Overview](00-Overview.md) | System purpose, actors and roles, top-level activities, high-level architecture, technology choices |
...
| 05 | [Import Pipeline](05-Import-Pipeline.md) | Three-stage extract → map → import pipeline, domain mappers, docx round-trip export |
...
| 08 | [Web Client](08-Web-Client.md) | Vanilla JS SPA (ODIP Space), component patterns, activity architecture, TipTap rich text, CSS architecture |
