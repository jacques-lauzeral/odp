...
- name: mandatory - short text
- version: optional - short text
- url: mandatory - URL
...
- id: mandatory - opaque identifier
- name: mandatory - short text
- description: mandatory - multiline rich text
- parent: optional - the parent stakeholder category
...
- name: mandatory - short text
- description: mandatory - multiline rich text
- contact: mandatory - multiline rich text
- parent: optional - the parent domain
...
- id: mandatory - opaque identifier
- year: mandatory - one year
- wave: optional - Wave reference - undefined means year
- scope: optional - Domain reference - undefined means global scope
...
- implements (Implements): forbidden for ONs, mandatory for root ORs, optional otherwise - the list of implemented ONs
...
- implements (Implements): mandatory for root ORs, optional otherwise - the list of implemented ONs
...
- implements (Implemented ORs): mandatory - the list of implemented ORs
- decommissions (Decommissioned ORs): mandatory - the list of decommissioned ORs
