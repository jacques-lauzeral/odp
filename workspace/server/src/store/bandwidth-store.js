 ...
 *
 * Fields: year (integer), planned (integer, optional), waveId (optional), scope (optional DraftingGroup key).
 * The (year, waveId, scope) tuple is unique — enforced at the service layer.
 */
